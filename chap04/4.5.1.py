...
# 카메라 속성 획득 및 출력
print("너비 %.2f" % capture.get(cv2.CAP_PROP_FRAME_WIDTH))
print("높이 %.2f" % capture.get(cv2.CAP_PROP_FRAME_HEIGHT))
print("노출 %.2f" % capture.get(cv2.CAP_PROP_EXPOSURE))
print("밝기 %.2f" % capture.get(cv2.CAP_PROP_BRIGHTNESS))
